...
public class ScraperClient {
     ...
     * the URL through {@link com.np.pricehunt.backend.validator.UrlValidator#validateForScrape(String)}
     * (or {@code validate} on user input) — this method performs no host validation. Enforced today at
     * the shared pre-scrape chokepoint in {@code ProductTrackingService.trackAndPersist} (the sole
     * caller); making the sink self-validating is a filed follow-up.
     */
