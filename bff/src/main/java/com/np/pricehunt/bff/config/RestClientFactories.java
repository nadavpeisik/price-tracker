...
/**
 * Copied verbatim from the backend's {@code config/RestClientFactories} (a shared Maven module would turn
 * the backend into a multi-module build; revisit if a third copy appears).
 *
 * <p>Builds {@link JdkClientHttpRequestFactory} instances with explicit timeouts, centralizing the
